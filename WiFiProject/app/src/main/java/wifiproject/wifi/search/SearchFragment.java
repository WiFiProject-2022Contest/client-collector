    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        switch (MainActivity.building) {
            ...
            case "Library3F":
                ...
                break;
            case "WiFiLocation2F":
                imageview_map2.setImage(ImageSource.resource(R.drawable.wifilocation_gimpo_2f_ice_temp_mezzanine_bottom));
                break;
            case "WiFiLocation3FTop":
                imageview_map2.setImage(ImageSource.resource(R.drawable.wifilocation_gimpo_3f_room_temp_mezzanine_top));
                break;
            case "WiFiLocation3F":
